...
export default function BookingForm() {
  ...
  // Effect to handle optional redirect after 8 seconds
  useEffect(() => {
    let timer;
  ...
  const handleSubmit = async (e) => {
    ...
    const API_URL =
      ...
      "https://toros-steakhouse-server.onrender.com";
    ...
    >
      <div className="bg-black/50 w-full h-full py-16">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-center gap-10">
          <div
            className={`w-full flex justify-center mt-24 transition-all duration-300 ${
