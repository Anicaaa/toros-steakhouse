function Hero() {
    return (
        ...
        style={{
          backgroundImage: `url('/steakhousetwo.jpg')`,
        }}
      >
        <div className="max-w-xl bg-black/60 p-8 mx-auto text-center rounded-md text-white">
          ...
          <div className="flex justify-center gap-4">
            <button className="bg-red-700 hover:bg-red-700 text-white px-6 py-3 rounded-sm font-semibold tracking-wide">
              Book Now
            </button>

            <button className="bg-white text-black px-6 py-3 rounded-sm font-semibold tracking-wide border border-black">
              View Menu
            </button>
          </div>
        </div>
